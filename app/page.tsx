  ...
  return (
    <main>
      ...
      <section className="hero" id="top">
        ...
        <div className="hero-visual"><div className="sun-disc" /><div className="hero-image-wrap"><img src="/hibiscus-shea-butter.jpg" alt="Sienna Shea Butter hibiscus-infused product jar" /></div><p className="image-note">A little ritual for your wash day.</p></div>
      </section>
      ...
      <section className="product-section">
        <div className="product-photo"><img src="/hibiscus-shea-butter.jpg" alt="Close-up of Sienna Shea Butter packaging" /></div>
